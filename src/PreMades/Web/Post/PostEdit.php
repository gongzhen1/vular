<?php
namespace Water\Vular\PreMades\Web\Post;
...
use Water\Vular\Models\PostAttribute;
use Water\Vular\Models\PostCategory;
use Water\Vular\Models\PostTag;
...
class PostEdit extends TwoColumnsFormPage{
    protected $modelClass = \Water\Vular\Models\Post::class;
