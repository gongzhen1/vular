...
class Post extends Model{
    ...
    public function attributes(){
        return $this->belongsToMany('Water\Vular\Models\PostAttribute');
    }

    public function categories(){
        return $this->belongsToMany('Water\Vular\Models\PostCategory');
    }

    public function tags(){
        return $this->belongsToMany('Water\Vular\Models\PostTag');
    }
